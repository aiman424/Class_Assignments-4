...
const Hero = () => {
  return (
    <section className='flex-grow p-4 bg-green-600 justify-center h-screen bg-custom'>
        <div className='mx-auto px-4 box-border rounded-sm outline-gray-800 flex flex-col min-h-screen'>
            <h1 className='text-2xl mb-4 text-cyan-900 text-center font-bold'>My Journey</h1>
            <p className='text-2xl mb-5'><b>As a programmer, my daily life is a unique blend of creativity and logic that constantly keeps me engaged.
             ...
             and I often find solace in connecting with others who share my passion. Every line of code I write not only</b></p>   
          </div>  
